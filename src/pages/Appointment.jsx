    ...
    <div>
      <div className="headd d-flex justify-content-around ">
        ...
        <div>
          <Link
            to="/Appointmentmodal"
            className="text-decoration-none  fw-light mx-3 hom"
          >
            My Appointment
          </Link>
          <Link to="/Login" className="text-decoration-none hom2 fw-light mx-3">
            Log Out
          </Link>{" "}
        </div>
      </div>
      ...
      <div className="d-md-flex justify-content-center app">
        <center className="form-app">
          ...
          <img src={line} alt="" /> <img src={line} alt="" />{" "}
          <img src={line} alt="" />
          <form>
            ...
            <Link
              to="/Appointmentmodal"
              className="text-decoration-none  fw-light mx-3"
            >
              REQUEST
            </Link>
          </form>
